    ...
    <main>
      <div class="content">
        <div class="l">
          <div class="bigImg">
            <img
              :src="httpImg + productInfo.coverImg"
              width="100%"
              height="100%"
              alt=""
            />
          ...
          <ul>
            ...
            >
              <img
                ...
                height="100"
                alt=""
                :style="{ opacity: currentImgIdx === index ? 1 : 0.5 }"
              />
            </li>
          </ul>
        </div>
        <div class="r">
          ...
          <div class="down">
            <section
              v-for="(text, index) in productInfo.parameterJson"
              :key="index"
            >
              <strong>选择{{ text.title }}</strong>
              <ul>
                <li
                  :class="{ active: patame.currentActivate }"
                  v-for="(patame, idx) in text.parameters"
                  :key="idx"
                  @click="goodsDetail(patame.id)"
                >
                  {{ patame.title }}
                </li>
              </ul>
...
<script>
import { getProductDetail, addShopCart } from "../request/httpApi";
export default {
  components: {},
  data() {
    return {
